...
12. [Chrome->ST IDE]   MyNestManagerV2- AppSettings/Settings section: Make sure that all your google_cookie_p* fields contain the whole cookie from Google. Please make sure to avoid inserting extra spaces or any other characters when you split the cookie as this will not be accepted by Google.
