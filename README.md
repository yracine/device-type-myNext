...
<b>NOTE: If you have many Nest devices (more than 10), due to the ST platform's rate limiting, it is strongly recommended to split your Nest devices into several instances of MyNextManagerV2 (you can rename them in the app as you please: ex MyNextManagerProtects for your protects, MyNestManagerTstatAndSensors).</b>
